...
CREATE TABLE `favoritos_has_cadastro_cliente` (
  ...
  CONSTRAINT `fk_favoritos_has_cadastro_cliente_cadastro_cliente1` FOREIGN KEY (`cadastro_cliente_id_cliente`) REFERENCES `cadastro_cliente` (`id_cliente`),
  CONSTRAINT `fk_favoritos_has_cadastro_cliente_favoritos1` FOREIGN KEY (`favoritos_id_favoritos`) REFERENCES `favoritos` (`id_favoritos`)
...
-- Dump completed on 2023-07-18 21:50:06
