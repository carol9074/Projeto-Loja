...
CREATE TABLE `fornecedores_has_produtos` (
  ...
  PRIMARY KEY (`fornecedores_id_fornecedor`,`produtos_id_produtos`),
  ...
  CONSTRAINT `fk_fornecedores_has_produtos_fornecedores1` FOREIGN KEY (`fornecedores_id_fornecedor`) REFERENCES `fornecedores` (`id_fornecedor`),
  CONSTRAINT `fk_fornecedores_has_produtos_produtos1` FOREIGN KEY (`produtos_id_produtos`) REFERENCES `produtos` (`id_produtos`)
...
-- Dump completed on 2023-07-18 21:50:03
