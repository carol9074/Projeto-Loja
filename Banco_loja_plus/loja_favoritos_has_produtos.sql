...
CREATE TABLE `favoritos_has_produtos` (
  ...
  CONSTRAINT `fk_favoritos_has_produtos_favoritos1` FOREIGN KEY (`produtos_id_produtos`) REFERENCES `produtos` (`id_produtos`),
  CONSTRAINT `fk_favoritos_has_produtos_produtos1` FOREIGN KEY (`produtos_id_produtos`) REFERENCES `cadastro_cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-08-11 21:52:19
